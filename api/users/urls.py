...
from .views import RegisterAPIView, LoginAPIView, \
    ...
    CheckManagerAPIView, GetUserByPkAPIView, GetManagersAPIView
...
urlpatterns = [
    ...
    path('get_managers/', GetManagersAPIView.as_view()),
    ...
    path('get_user_by_pk/<pk>/', GetUserByPkAPIView.as_view()),
