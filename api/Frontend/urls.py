...
urlpatterns = [
    ...
    path('ru/select_place/', SelectPlaceForOrderViewRU.as_view(), name='select_place_view_ru'),
    ...
    path('uz/select_place/', SelectPlaceForOrderViewUZ.as_view(), name='select_place_view_uz'),
